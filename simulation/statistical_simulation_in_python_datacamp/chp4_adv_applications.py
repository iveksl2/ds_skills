#--- Simulating a business corn profit ---
...
print("Simulated answer = {}, Actual Answer = 1".format(result))o
...
# Calculate the 95% CI
lower_ci = np.quantile(rets,.025)
upper_ci = np.quantile(rets,.975)
print("95% CI of Returns: Lower = {}, Upper = {}".format(lower_ci, upper_ci))

for i in range(sims):
    rets_stock.append(portfolio_return(yrs = 10, avg_return = 0.07, volatility = .3, principal = 10000))
    rets_bond.append(portfolio_return(yrs = 10, avg_return = .04, volatility = .1, principal = 10000))

# Calculate the 25th percentile of the distributions and the amount you'd lose or gain
rets_stock_perc = np.quantile(rets_stock,.25)
rets_bond_perc = np.quantile(rets_bond,.25)
